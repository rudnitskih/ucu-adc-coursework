...
![Image of console](./dijkstra/source/result/framework.png "Image of console")

All raw results, which generated by application, can be found in results folder in .txt files. We used the Ipytho notebook to prepare final charts. Charts were ploted by matplotlib libary.
