...
from Dijkstra import shortest_path, dijkstra_with_heap
...
class Graph_Test(unittest.TestCase):
    ...
    def test_shortest_path(self, ):
        ...
        self.assertEqual(shortest_path(self.graph, 'A', 'E'), (55, ['A', 'B', 'D', 'E']))
        self.assertEqual(shortest_path(self.graph, 'A', 'G'), (62, ['A', 'B', 'D', 'E', 'F', 'G']))

    def test_for_one(self, ):
        self.graph.add_node('A')
        self.assertEqual(shortest_path(self.graph, 'A', 'G'), "There is no sense in your request!")
