...
![Application screenshot](./sorting/results/sapplication_screenshot.png "Application screenshot")
...
All raw results, which generated by application, can be found in [results](./sorting/results/s) folder in .csv files. We used the free LibreOffice to prepare final charts.

There are final tables for each algorithm:

![Heapsort results](./sorting/results/stable_heapsort.png "Heapsort results")
![Quicksort results](./sorting/results/stable_quicksort.png "Quicksort results")
...
![Average estimations for Heapsort](./sorting/results/saverage_estimation(heapsort).png "Average estimations for heapsort")

For Quicksort algorithm:
![Average estimations for Quicksort](./sorting/results/saverage_estimation(quicksort).png "Average estimations for Quicksort")

To answer the question "Which algorithm faster Heapsort vs Quicksort?", we built charts for both data types:

![Dates results](./sorting/results/sdates_time_sorting.png "Dates results")
![Reals results](./sorting/results/sreals_time_sorting.png "Reals results")
