...
All raw results, which generated by application, can be found in results folder in .txt files. We used the Ipython notebook to prepare final charts. Charts were plotted by matplotlib library.
...
As we can see in our tables both version of algorithm have Scale factor nearly constant, this fact says us that our implementation is correct.

**Let's look at efficiency of both algorithms:**
...
Looking at this graphs we can confirm our assumption about algorithm's efficiency. As we can see Heap-Based version much more faster, than  straightforward as we assumed. 

As we can see number of operations is linear depended with number of vertices as it should.
...
At the end of this implementation we understand that it's very important to choose right data structure for algorithm and this case really impressed us how it's important.
...
![Bellman-Ford, connectivity 0.1](./graphs/negative-cycle/images/bf_0.10.png "Bellman-Ford, connectivity 0.1")
![Bellman-Ford, connectivity 0.1](./graphs/negative-cycle/images/bf_0.25.png "Bellman-Ford, connectivity 0.25")
![Bellman-Ford, connectivity 0.1](./graphs/negative-cycle/images/bf_1.00.png "Bellman-Ford, connectivity 1.0")
...
![Floyd-Warshall, connectivity 0.1](./graphs/negative-cycle/images/fw_0.10.png "Floyd-Warshall, connectivity 0.1")
![Floyd-Warshall, connectivity 0.1](./graphs/negative-cycle/images/fw_0.25.png "Floyd-Warshall, connectivity 0.25")
![Floyd-Warshall, connectivity 0.1](./graphs/negative-cycle/images/fw_1.00.png "Floyd-Warshall, connectivity 1.0")
...
### Comparison
![Comparison, connectivity 0.1](./graphs/negative-cycle/images/bf_fw_0.10.png "Comparison, connectivity 0.1")
![Comparison, connectivity 0.1](./graphs/negative-cycle/images/bf_fw_0.25.png "Comparison, connectivity 0.25")
![Comparison, connectivity 0.1](./graphs/negative-cycle/images/bf_fw_0.50.png "Comparison, connectivity 0.5")
